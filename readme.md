...
3. Check the generated XML file:
...
3. The default output is `NBC_News.xml` in the repository root. You can pass a custom file path as an argument:
...
- Inspired by and based on [yurividal/dummyepgxml](https://github.com/yurividal/dummyepgxml)
